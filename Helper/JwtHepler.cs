...
namespace ASPNET5Demo1.Helper
{
    public class JwtHelper
    {
        ...
        public string GenerateToken(string userName, int expireMinutes = 30)
        {
            ...
            var signKey = Configuration.GetValue<string>("JwtSettings:SignKey");//不得小於16位元
            ...
            {
                Issuer = issuer,
                //Audience = issuer, // Sometimes you don't have to define Audience,多站台運用，身份不同
